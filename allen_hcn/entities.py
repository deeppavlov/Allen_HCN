...
class EntityTracker(Registrable):
    ...
    @classmethod
    def from_params(cls, params: Params) -> 'EntityTracker':
        """
...
@EntityTracker.register("hcn_et")
class HCNEntityTracker(EntityTracker):
    def __init__(self):
        self.entities = {
            '<cuisine>': None,
            '<location>': None,
        ...
        # constants
        self.party_sizes = ['1', '2', '3', '4', '5', '6', '7', '8', 'one', 'two', 'three', 'four',
